...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /** Listeners */
        listViewXML.setOnItemClickListener { adapterView, view, pos, l ->
            val pj = listPersonaje[pos]
            val intent = Intent(this, PersonajeInfo::class.java)
        ...
        listViewXML.setOnItemLongClickListener { adapterView, view, pos, l ->
            eliminar(pos)

            //Return necesario para que funcione el OnLongClick
